...
public class second {
    ...
    public static void main(String[] args) {
        ...
        SecondLargestAndSmallest(numbers, result);
        System.out.println("The second largest number in the list is: " + result[0]);
        System.out.println("The second smallest number in the list is: " + result[1]);
        scanner.close();
    }
}
